					...
					<form name="myForm" id="myForm" method="post" enctype="multipart/form-data" action="{{url('ticket-creation-data')}}">
						...
						<div class="row">
							...
							<div class="form-group col-md-3">
								...
								<span style="color: red;">*</span>
									<select name="add_blue_use" id="add_blue_use" class="form-control" required>
						...
						<div class="row">
							...
							<div class="form-group col-md-3">
								...
								<span style="color: red;">*</span>
									<input type="text" name="owner_mob" id="owner_mob" class="form-control"  placeholder="Mobile Number" maxlength="10" required/>
							</div>
							<div class="form-group col-md-3">
						...
						<div class="row">
							<div class="form-group col-md-3">
								...
								<span style="color: red;">*</span>
									...
									<select name="contact_name" id="contact_name_select" class="form-control" style="display: none;" onchange="contactNameData(this.value)"></select> 
							</div>
							<div class="form-group col-md-3">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#actual_response_time').datetimepicker({format:'Y-m-d H:i:s'});
		$('#tat_scheduled').datetimepicker({format:'Y-m-d H:i:s'});
	});
